...
import '../util/service_list_tile.dart';
...
class _ServicePageState extends State<ServicePage> {
  final TextEditingController _serviceName = TextEditingController(text: '');
  ...
  Future<void> _initData()async{
    if(PublicController.pc.serviceList.value.data==null){
      await PublicController.pc.getAllService();
    }
  }
            ...
            bottomNavigationBar: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(child: Text('${pc.serviceList.value.data!=null? pc.serviceList.value.data!.data!.length:''}',textAlign: TextAlign.end,
  ...
  Widget _bodyUI(PublicController pc)=>RefreshIndicator(
    ...
    child: pc.serviceList.value.data!=null
        ?ListView.separated(
        physics: const BouncingScrollPhysics(),
        padding: EdgeInsets.symmetric(horizontal: dSize(.04),vertical: dSize(.02)),
        itemCount: pc.serviceList.value.data!.data!.length,
        itemBuilder: (context, index)=> ServiceListTile(servicemodel: pc.serviceList.value.data!.data![index]),
                ...
                return SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFieldTile(controller:  _serviceName, labelText: 'পণ্যের নাম',textCapitalization: TextCapitalization.words),
